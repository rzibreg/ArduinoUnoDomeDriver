...
// With safety sensor for telescope
//
...
namespace ASCOM.ArduinoUno.Dome
{
    ...
    //
    // Your driver's DeviceID is ASCOM.ArduinoUno.Dome
    //
    // The COM Guid attribute sets the CLSID for ASCOM.ArduinoUno.Dome
    // The COM ClassInterface/None attribute prevents an empty interface called _ArduinoUno from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("da4517f6-bb4b-42a0-a2b8-2e8e8169c5ac")]
    [ProgId("ASCOM.ArduinoUno.Dome")]
    [ServedClassName("ArduinoUno Dome")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Dome : ReferenceCountedObjectBase, IDomeV3, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArduinoUno"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Dome()
        {
            try
            {
                ...
                tl = new TraceLogger("", "ArduinoUno.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            set
            {
                try
                {
                    ...
                    if (value)
                    {
                        ...
                        DomeHardware.SetConnected(uniqueId, true);
                    ...
                    else
                    {
                        ...
                        DomeHardware.SetConnected(uniqueId, false);
        ...
        public void Disconnect()
        {
            try
            {
                ...
                DomeHardware.Disconnect(uniqueId);
            }
            catch (Exception ex)
            {
