...
namespace ASCOM.LocalServer
{
    ...
    public static class SharedResources
    {
        ...
        private static SafetyStatusEnum _safetyStatus = SafetyStatusEnum.Unknown;
        private static RoofStatusEnum _roofStatus = RoofStatusEnum.Unknown;
        private static string _receivedStatus = String.Empty;

        // Public access to shared resources
        public static event EventHandler<EventArgs> RoofStatusChanged;
        public static event EventHandler<EventArgs> SafetyStatusChanged;
        public static event EventHandler<EventArgs> ReceivedStatusChanged;

        public static RoofStatusEnum RoofStatus
        {
            get => _roofStatus;
            set
            {
                _roofStatus = value;
                RoofStatusChanged?.Invoke(null, EventArgs.Empty);
            }
        }

        public static SafetyStatusEnum SafetyStatus
        {
            get => _safetyStatus;
            set
            {
                _safetyStatus = value;
                SafetyStatusChanged?.Invoke(null, EventArgs.Empty);
            }
        }
        ...
        public static string ReceivedStatus
        {
            ...
            set
            {
                ...
                ReceivedStatusChanged?.Invoke(null, EventArgs.Empty);
            }
        }

        public enum SafetyStatusEnum
        {
            Safe,
            Unsafe,
            Unknown
